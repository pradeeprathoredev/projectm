...
import layout.BookAppointment;
import layout.Doctors;
import layout.Hospital;
import layout.MyAppointment;
import layout.MyReport;
...
public class NevigationDrawer extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       displaySelectedScreen(R.id.nav_bookAppo);
    }
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_bookAppo:
                fragment = new BookAppointment();
                break;
            case R.id.nav_myappo:
                fragment = new MyAppointment();
                break;
            case R.id.nav_doctros:
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
       ...
       /* int id = item.getItemId();
        ...
        if (id == R.id.nav_bookAppo) {
            // Handle the camera action
        } else if (id == R.id.nav_myappo) {

        } else if (id == R.id.nav_myreport) {

        } else if (id == R.id.nav_doctros) {
